-- =============================================
-- Phase 9 致命傷ライン本実装：migration 確定版
-- =============================================
-- 起票：2026-05-08 / Phase 9-A まーちゃん
-- 確定：2026-05-14（時吉さん「全て任せます」→ 全項目まーちゃん推奨を採用）
-- 復元ポイント：restore-point-2026-05-14
-- 前提：致命傷ライン15項目+入荷論点3項目=計18項目すべて確定済み
--   DB-1〜5: D / D / B / B / D  (4軸 / 荷主切替 / SKUフラグシリアル / 論理分離+RLS / 階層×機能種別)
--   BF-2/3: D / D            (多軸+荷主切替 / 切替制)
...
-- レビュー：今井先生コメントは並行受領・覆る場合は restore-point-2026-05-14 へ復帰
-- 適用：Supabase の apply_migration MCP ツール経由（さーちゃん主担当）
-- 実装状況（2026-05-14 時点）：
--   Stage 1 (DB-4 + AU-1 + AU-2)        : ✅ completed (todos #818, #821, #392)
--   Stage 1 検証 (QA2)                  : ✅ completed (#394)
--   Stage 2 (DB-1/2/3/5 + locations)    : 🔄 一部進行 (DB-5 locations completed #862)
--   Stage 3 (BF系・業務フロー)          : 🔄 一部進行
--   Stage 4 (CA-1 billing + 連携)       : 🔄 一部進行 (CA-1 billing_rules completed #863)
-- =============================================
